interface Props {
  ...
  /** Qué se está paginando, para que el anuncio diga "de 73 facturas" y no "de 73 elementos". */
  entidad: string
  onCambiarPagina: (pagina: number) => void
}

/**
 * Control de paginación del módulo (FR-059), con la misma forma que el del Módulo 5.
 *
 * Muestra el **total de coincidencias**, no las de la página: es lo que permite saber cuántas facturas
 * cumplen el filtro sin ir a la última página a contar.
 *
 * El cambio de página se anuncia con `role="status"` (convención [003]): es un resultado que aparece sin
 * que la pantalla cambie, y quien usa lector de pantalla necesita enterarse de que la lista se renovó.
 */
