...
- [X] T091 Recorrer los 43 pasos de `specs/010-gestion-adelantos/quickstart.md` con las cuatro cuentas (`admin`, `admin.empresa`, `gerencia`, `trafico`), incluidos los dos pasos de dos navegadores (13 y 20) y los tres de los Módulos 6 y 9 (41 a 43), y anotar lo que el recorrido encuentre
