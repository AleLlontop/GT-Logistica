...
- [X] T087 Recorrer los 19 pasos de `specs/011-gestion-caja/quickstart.md` con las cuentas `admin`, `admin.empresa`, una segunda cuenta de *Administración de la empresa*, `gerencia` y `trafico`, incluido el paso 12 de dos pestañas, y anotar lo que el recorrido encuentre
